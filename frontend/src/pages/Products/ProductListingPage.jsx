    ...
    import { getCategories } from '../../api/categories'; // استيراد دالة جلب الفئات
    import { getBrands } from '../../api/brands';       // استيراد دالة جلب العلامات التجارية
    ...
    const ProductListingPage = () => {
      ...
      const [brands, setBrands] = useState([]);       // حالة لتخزين العلامات التجارية
      ...
      const fetchProducts = useCallback(async () => {
        ...
        try {
          ...
          setError('فشل تحميل المنتجات. الرجاء المحاولة لاحقاً.');
          console.error(err);
        } finally {
          setLoading(false);
        }
      ...
      // دالة لجلب الفئات والعلامات التجارية عند تحميل المكون
      ...
      useEffect(() => {
        fetchProducts();
        fetchCategoriesAndBrands(); // ****** استدعاء دالة جلب الفئات والعلامات التجارية ******
      ...
      return (
        <div className="container my-5">
          <h1 className="text-center mb-4 fw-bold">منتجاتنا</h1>
