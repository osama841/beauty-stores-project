...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\beauty-store-project\backend\public\storage' => 'string',
...
'app.aliases.Vite','app.aliases.Files','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'filesystems.links.C:\\xampp\\htdocs\\beauty-store-project\\backend\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'addresses.index','addresses.store','addresses.show','addresses.update','addresses.destroy',
'orders.index','orders.store','orders.show','orders.update','orders.destroy',
'order-items.index','order-items.store','order-items.show','order-items.update','order-items.destroy',
'shopping-cart.index','shopping-cart.store','shopping-cart.show','shopping-cart.update','shopping-cart.destroy',
'reviews.index','reviews.store','reviews.show','reviews.update','reviews.destroy',
'product-images.index','product-images.store','product-images.show','product-images.update','product-images.destroy',
'payments.index','payments.store','payments.show','payments.update','payments.destroy',
'product-attributes.index','product-attributes.store','product-attributes.show','product-attributes.update','product-attributes.destroy',
'discounts.index','discounts.store','discounts.show','discounts.update','discounts.destroy','storage.local',);
